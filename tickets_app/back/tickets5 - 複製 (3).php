...
$rs6 = mysql_query($query_rs6, $connSQL) or die(mysql_error());
...
$buy = mysql_query($query_buy, $connSQL) or die(mysql_error());
	  ...
	  <header class="major">
				...
				<div class="container">
				  <section>
			            ...
			            <div align="center"><img src="jpg/FTKMHGK.jpg" alt="" width="100%" height="212" /><span class="style5">訂票完畢</span></div>
