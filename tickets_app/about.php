			...
			<header id="header" class="skel-layers-fixed">
				...
				<nav id="nav">
					<ul>
						...
						<li><a href="about.php" class="button special">關於我們</a></li>
				...
				<div class="container">
					<div class="row">
						<div class="8u">
							<section>
								<h2>關於我們 About </h2>
								<p><a href="#" class="image fit"><img src="jpg/3.jpg" alt="" /></a></p>
								<p>	<h3>開發人員資訊</h3> 
								</p>
								<p>內容提供  :  淡江大學 <a name="_GoBack"></a>資管 系 <br>
							    連絡電話  :   0937-027-731</p>
								<p>開發團隊  :    陳信茗 林建廷 陳威志 蕭允誠 呂文瀚 </p>
