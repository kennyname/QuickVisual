...
<body>
<div align="center">
  <p><img src="../image/hfgdh.jpg" width="795" height="236"><br>
  類別管理</p>
...
<table width="277" border="1" align="center">
  <tr>
    <td width="197" bgcolor="#434448"><div align="center" class="style1 style2">類別名稱</div></td>
    <td width="64" bgcolor="#434448"><div align="center"><span class="style1"><span class="style2"></span></span></div></td>
  </tr>
  <?php do { ?>
  <tr>
    <td bgcolor="#434448"><div align="center" class="style3"><?php echo $row_rs['s_product_ps']; ?></div></td>
    <td bgcolor="#434448"><div align="center" class="style3"><a href="s_upstore_ps_del.php?id=<?php echo $row_rs['s_product_ps_id']; ?>">刪除</a></div></td>
  </tr>
