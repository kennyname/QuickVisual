...
$query_rs = sprintf("SELECT * FROM order_prod a left join s_product b on a.o_pro=b.pro_id WHERE a.o_acc = '%s' order by o_id desc", $colname_rs);
		  ...
		  <p>&nbsp;</p>
				...
				<div class="container">
					<section>
						...
						<a href="#" class="image fit"> <img src="jpg/8.jpg" width="100%" height="216"></a></section>
		</div>
	</section>
				  ...
				  <div class="row">
						...
						<?php do { ?>
						  <div class="4u">
							...
							<a href="QR.php?c=<?php echo $row_rs['o_checkout'];?>&id=<?php echo $row_rs['o_id']; ?>">
